...
describe("Tests for TransferMenu component", () => {
  ...
  test("Clicking an element inside the available pane transfers it to the outbound pane", () => {
    ...
    expect(screen.getByRole("heading", {name: "Outgoing"}).parentNode.querySelector("[data-testId=element]")).toBeNull();
    ...
    expect(screen.getByRole("heading", {name: "Outgoing"}).parentNode.querySelector("[data-testId=element]")).not.toBeNull();
